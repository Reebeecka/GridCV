...
function english(){
    ...
    headerAboutText.innerHTML="Hello! I'm looking for a Lia-spot at yours! I'm a nice girl, 24 years old who loves front-end development. My favorite language is probably CSS, even though JavaScript is a very close second. I live in Västerås with my partner and dog. I love to travel together with my family, and I'm also very active in Swedish rugby as being on the board, managing a team and refereeing. I've always done team sports and that have helped me in my collaboration with others. I'm a very social girl that likes to both work and hang out with others, even if It’s sometimes very enjoyable to sit down and write some code alone sometimes. I've always been praised for being a fast worker and learner, even though I might sometimes be a bit too fast. In my latest workplace I worked in administration with solving technical issues, salaries and economic reports, this has enhanced my ability to problem-solve, but it also helped me become good at Excel. If you scroll down, you see some of my skills and how good I feel that I am at those skills, you also see some of my projects from school. I hope to see you in October during my first Lia-period! Thank you!";
    project1Header.innerHTML="To the moon";
    project1Text.innerHTML="Above is a project from school with the purpose of learning to position in CSS and also work from a client specification. Hover over the image to see page 2 of the website";
    project2Header.innerHTML="My first resumé";
    project2Text.innerHTML="Above is a self-designed project that we worked on in school. I was not happy, hence why I created the page you are currently on (ha-ha)";
    project3Header.innerHTML="Cities and Countries";
    project3Text.innerHTML="Above is a JavaScript project that I created together with a group in school. The project is based on several APIs that shows you the population, weather, common facts and the most recent news from a country and its cities.";
    project4Header.innerHTML="Game Covid";
    project4Text.innerHTML="Above is also a group project where we had the assignment to create a game to learn about collision and keystrokes. In the game, we have created the characters that are supposed to chase each other and score points";
...
function svenska(){
    ...
    project2Text.innerHTML="Ovan är ett egen-designat projekt som vi arbetade med i skolan. Jag var inte nöjd och skapade därför sidan du är på just nu (haha)";
    project3Header.innerHTML="Städer och Länder";
    project3Text.innerHTML="Ovan är ett JavaScript projekt som jag tillsammans med en grupp i skolan skapat. Projektet är uppbyggt på APIer där du får fram population, väder, vanliga fakta samt den senaste nyheten från ett land samt de tillhörande städerna till landet";
...
function hoverImg(img){
    img.src = "/RebeckaLarsson/project1hover.PNG";
}
